...
set additional_include=/I %VULKAN_SDK%\Include /I thirdparty\GLFW /I thirdparty\volk

cl %additional_include% -DVK_USE_PLATFORM_WIN32_KHR -DGLFW_EXPOSE_NATIVE_WIN32 -DWIN32_LEAN_AND_MEAN -DDEBUG_BUILD -nologo -Zi -GR- -EHa- -Odi %warning_opts% user32.lib gdi32.lib shell32.lib %VULKAN_SDK%\Lib\vulkan-1.lib "src\veng_main.cpp" "thirdparty\glfw3_mt.lib" %compile_out%
